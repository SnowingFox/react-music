...
export const Icons = {
  NeteaseCloudMusicIcon: <i className={'i-ri:netease-cloud-music-fill'} />,
  RadioPodcastIcon: <i className={'i-ion:radio-outline'} />,
  MusicNotes: <i className={'i-ph:music-notes'} />,
